rule assembly:
    input:
        rarefaction_reads_1 = "results/{sample}/rarefaction_reads/{sample}_1.rarefaction_reads.fastq",
        rarefaction_reads_2 = "results/{sample}/rarefaction_reads/{sample}_2.rarefaction_reads.fastq",
    output:
